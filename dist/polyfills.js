...
(function () {
  function bootstrap() {
    ...
    (function (global) {
      ...
      if (!__global.console) __global.console = { assert: function assert() {} };
      ...
      (function () {
        try {
          if (!!Object.defineProperty({}, 'a', {})) defineProperty = Object.defineProperty;
        } catch (e) {
          defineProperty = function defineProperty(obj, prop, opt) {
            try {
      ...
      function addToError(err, msg) {
        ...
        if (!err.originalErr) {
          ...
          for (var i = 0; i < stack.length; i++) {
            if (typeof $__curScript == 'undefined' || stack[i].indexOf($__curScript.src) == -1) newStack.push(stack[i]);
          }
        }
      ...
      */
      ...
      (function () {
        ...
        function proceedToLocate(loader, load) {
          proceedToFetch(loader, load, Promise.resolve()
        ...
        function proceedToFetch(loader, load, p) {
          proceedToTranslate(loader, load, p
        ...
        function proceedToTranslate(loader, load, p) {
          ...
          .then(function (source) {
            ...
            .then(function (instantiateResult) {
              ...
              } else if ((typeof instantiateResult === 'undefined' ? 'undefined' : _typeof(instantiateResult)) == 'object') {
            ...
            .then(function () {
              ...
              for (var i = 0, l = depsList.length; i < l; i++) {
                (function (request, index) {
                  loadPromises.push(requestLoad(loader, request, load.name, load.address)
          ...
          return function (resolve, reject) {
            ...
            for (var i = 0, l = loader.loads.length; i < l; i++) {
              if (loader.loads[i].name == name) {
                ...
                if (existingLoad.linkSets.length && existingLoad.linkSets[0].loads[0].name == existingLoad.name) return existingLoad.linkSets[0].done.then(function () {
        ...
        function linkSetFailed(linkSet, load, exc) {
          ...
          for (var i = 0, l = loads.length; i < l; i++) {
            ...
            if (indexOf.call(loader.loaderObj.failed, load) == -1) loader.loaderObj.failed.push(load);
        ...
        Loader.prototype = {
          ...
          constructor: Loader,
          // 26.3.3.2
          define: function define(name, source, options) {
          ...
          // 26.3.3.8
          'import': function _import(name, parentName, parentAddress) {
            if ((typeof parentName === 'undefined' ? 'undefined' : _typeof(parentName)) == 'object') parentName = parentName.name;
          ...
          // 26.3.3.11
          module: function module(source, options) {
            var load = createLoad();
          ...
          // 26.3.3.12
          newModule: function newModule(obj) {
            if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) != 'object') throw new TypeError('Expected object');

            var m = new Module();

            var pNames = [];
            if (Object.getOwnPropertyNames && obj != null) pNames = Object.getOwnPropertyNames(obj);else for (var key in obj) {
              pNames.push(key);
            ...
            }if (Object.freeze) Object.freeze(m);
      ...
      function applyPaths(paths, name) {
        ...
        for (var p in paths) {
          ...
          if (pathParts.length == 1) {
            ...
            else if (name.substr(0, p.length - 1) == p.substr(0, p.length - 1) && (name.length < p.length || name[p.length - 1] == p[p.length - 1]) && paths[p][paths[p].length - 1] == '/') return paths[p].substr(0, paths[p].length - 1) + (name.length > p.length ? '/' + name.substr(p.length) : '');
          }
          // wildcard path match
          else {
      ...
      var transpile = function () {
        ...
        function typescriptTranspile(load, ts) {
          ...
          if (options.sourceMap && options.inlineSourceMap !== false) options.inlineSourceMap = true;
        ...
        if ((typeof exports === 'undefined' ? 'undefined' : _typeof(exports)) == 'object' || typeof exports == 'function') {
          ...
          if (getOwnPropertyDescriptor) {
            for (var p in exports) {
              if (!trySilentDefineProperty(esModule, exports, p)) setPropertyIfHasOwnProperty(esModule, exports, p, hasOwnProperty);
            }
          } else {
            for (var p in exports) {
      ...
      function setPropertyIfHasOwnProperty(targetObj, sourceObj, propName, hasOwnProperty) {
        if (!hasOwnProperty || sourceObj.hasOwnProperty(propName)) targetObj[propName] = sourceObj[propName];
      }

      function trySilentDefineProperty(targetObj, sourceObj, propName) {
        try {
          var d;
          if (d = Object.getOwnPropertyDescriptor(sourceObj, propName)) defineProperty(targetObj, propName, d);
      ...
      function extendMeta(a, b, prepend) {
        for (var p in b) {
          var val = b[p];
          if (!(p in a)) a[p] = val;else if (val instanceof Array && a[p] instanceof Array) a[p] = [].concat(prepend ? val : a[p]).concat(prepend ? a[p] : val);else if ((typeof val === 'undefined' ? 'undefined' : _typeof(val)) == 'object' && val !== null && _typeof(a[p]) == 'object') a[p] = extend(extend({}, a[p]), val, prepend);else if (!prepend) a[p] = val;
        }
      }
      ...
      if ("function" != 'undefined' && typeof process != 'undefined' && !process.browser) SystemJSLoader.prototype._nodeRequire = !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }());
      ...
      function urlResolve(name, parent) {
        if (parent) parent = parent.replace(/#/g, '%05');
      ...
      function coreResolve(name, parentName) {
        ...
        if (!isPlain(name)) return urlResolve(name, parentName);
        ...
        if (mapMatch) {
          ...
          if (!isPlain(name)) return urlResolve(name);
        }
        ...
        if (pathed && !isPlain(pathed)) return urlResolve(pathed);
      ...
      hook('normalize', function (normalize) {
        return function (name, parentName, skipExt) {
          ...
          if (!skipExt && this.defaultJSExtensions && resolved.substr(resolved.length - 3, 3) != '.js' && !isPlain(resolved)) resolved += '.js';
          return resolved;
        };
      });
      ...
      */
      hook('import', function (systemImport) {
        return function (name, parentName, parentAddress) {
          if (parentName && parentName.name) warn.call(this, 'SystemJS.import(name, { name: parentName }) is deprecated for SystemJS.import(name, parentName), while importing ' + name + ' from ' + parentName.name);
      ...
      */
      ...
      SystemJSLoader.prototype.config = function (cfg) {
        ...
        if ('loaderErrorStack' in cfg) {
          ...
          if (cfg.loaderErrorStack) $__curScript = undefined;else $__curScript = curCurScript;
        }

        if ('warnings' in cfg) loader.warnings = cfg.warnings;

        // transpiler deprecation path
        if (cfg.transpilerRuntime === false) loader._loader.loadedTranspilerRuntime = true;

        // always configure baseURL first
        if (cfg.baseURL) {
          var checkHasConfig = function checkHasConfig(obj) {
            for (var p in obj) {
              if (hasOwnProperty.call(obj, p)) return true;
            }
          };
        ...
        if (cfg.pluginFirst) loader.pluginFirst = cfg.pluginFirst;

        if (cfg.production) setProduction.call(loader, true);
        ...
        if (cfg.map) {
          ...
          for (var p in cfg.map) {
            ...
            if (typeof v !== 'string') {
              ...
              if (defaultJSExtension && prop.substr(prop.length - 3, 3) == '.js') prop = prop.substr(0, prop.length - 3);

              // if a package main, revert it
              var pkgMatch = '';
              for (var pkg in loader.packages) {
                if (prop.substr(0, pkg.length) == pkg && (!prop[pkg.length] || prop[pkg.length] == '/') && pkgMatch.split('/').length < pkg.split('/').length) pkgMatch = pkg;
              }
              if (pkgMatch && loader.packages[pkgMatch].main) prop = prop.substr(0, prop.length - loader.packages[pkgMatch].main.length - 1);
          ...
          if (objMaps) warn.call(loader, 'The map configuration for ' + objMaps + ' uses object submaps, which is deprecated in global map.\nUpdate this to use package contextual map with configs like SystemJS.config({ packages: { "' + p + '": { map: {...} } } }).');
        }
        ...
        if (cfg.packageConfigPaths) {
          ...
          for (var i = 0; i < cfg.packageConfigPaths.length; i++) {
            ...
            if (defaultJSExtension && normalized.substr(normalized.length - 3, 3) == '.js') normalized = normalized.substr(0, normalized.length - 3);
        ...
        if (cfg.bundles) {
          for (var p in cfg.bundles) {
            ...
            for (var i = 0; i < cfg.bundles[p].length; i++) {
              ...
              if (defaultJSExtension && normalizedBundleDep.substr(normalizedBundleDep.length - 3, 3) == '.js') normalizedBundleDep = normalizedBundleDep.substr(0, normalizedBundleDep.length - 3);
        ...
        if (cfg.packages) {
          for (var p in cfg.packages) {
            ...
            for (var q in pkg) {
              if (indexOf.call(packageProperties, q) == -1) warn.call(loader, '"' + q + '" is not a valid package configuration option in package ' + p);
        ...
        for (var c in cfg) {
          ...
          if (c == 'baseURL' || c == 'map' || c == 'packages' || c == 'bundles' || c == 'paths' || c == 'warnings' || c == 'packageConfigPaths' || c == 'loaderErrorStack') continue;
          ...
          if ((typeof v === 'undefined' ? 'undefined' : _typeof(v)) != 'object' || v instanceof Array) {
            ...
            for (var p in v) {
              ...
              if (c == 'meta' && p[0] == '*') {
                ...
                if (loader.defaultJSExtensions && resolved.substr(resolved.length - 3, 3) != '.js' && !isPlain(resolved)) resolved += '.js';
      ...
      (function () {
        ...
        function addDefaultExtension(loader, pkg, pkgName, subPath, skipExtensions) {
          ...
          if (!subPath || subPath[subPath.length - 1] == '/' || skipExtensions || pkg.defaultExtension === false) return subPath;

          // NB are you sure about this?
          // skip if we have interpolation conditional syntax in subPath?
          if (subPath.match(interpolationRegEx)) return subPath;
          ...
          if (!metaMatch && loader.meta) getMetaMatches(loader.meta, pkgName + '/' + subPath, function (metaPattern, matchMeta, matchDepth) {
            if (matchDepth == 0 || metaPattern.lastIndexOf('*') != metaPattern.length - 1) return metaMatch = true;
          });
        ...
        function applyPackageConfigSync(loader, pkg, pkgName, subPath, skipExtensions) {
          ...
          if (pkg.map) {
            ...
            if (mapMatch) return doMapSync(loader, pkg, pkgName, mapMatch, mapPath, skipExtensions);
          }
        ...
        function validateMapping(mapMatch, mapped, pkgName) {
          ...
          else if (mapped.substr(0, mapMatch.length) == mapMatch && mapMatch[mapMatch.length - 1] != '/' && mapped[mapMatch.length] == '/') throw new Error('Package ' + pkgName + ' has a recursive map for "' + mapMatch + '" which is not permitted.');
        }

        function doMapSync(loader, pkg, pkgName, mapMatch, path, skipExtensions) {
          var mapped = pkg.map[mapMatch];

          if ((typeof mapped === 'undefined' ? 'undefined' : _typeof(mapped)) == 'object') throw new Error('Synchronous conditional normalization not supported sync normalizing ' + mapMatch + ' in ' + pkgName);

          validateMapping(mapMatch, mapped, pkgName);

          // ignore conditionals in sync
          if (typeof mapped != 'string') mapped = mapMatch = path;
          ...
          else if (mapped.substr(0, 2) == './') return pkgName + '/' + addDefaultExtension(loader, pkg, pkgName, mapped.substr(2) + path.substr(mapMatch.length), skipExtensions);
        ...
        function doStringMap(loader, pkg, pkgName, mapMatch, mapped, path, skipExtensions) {
          ...
          // internal package map
          else if (mapped.substr(0, 2) == './') return Promise.resolve(pkgName + '/' + addDefaultExtension(loader, pkg, pkgName, mapped.substr(2) + path.substr(mapMatch.length), skipExtensions)).then(function (name) {
        ...
        function doMap(loader, pkg, pkgName, mapMatch, path, skipExtensions) {
          ...
          return loader['import'](pkg.map['@env'] || '@system-env', pkgName).then(function (env) {
            ...
            for (var e in mapped) {
              ...
              if (!negate && value || negate && !value) return mapped[e];
            }
          }).then(function (mapped) {
            if (mapped) {
              if (typeof mapped != 'string') throw new Error('Unable to map a package conditional to a package conditional.');
              validateMapping(mapMatch, mapped, pkgName);
              return doStringMap(loader, pkg, pkgName, mapMatch, mapped, path, skipExtensions);
            }
        ...
        hook('decanonicalize', function (decanonicalize) {
          return function (name, parentName) {
            if (this.builder) return decanonicalize.call(this, name, parentName, true);
            ...
            if (defaultExtension == undefined && pkg && pkg.meta) getMetaMatches(pkg.meta, decanonicalized.substr(pkgName), function (metaPattern, matchMeta, matchDepth) {
            ...
            if ((defaultExtension === false || defaultExtension && defaultExtension != '.js') && name.substr(name.length - 3, 3) != '.js' && decanonicalized.substr(decanonicalized.length - 3, 3) == '.js') decanonicalized = decanonicalized.substr(0, decanonicalized.length - 3);
        ...
        hook('normalizeSync', function (normalizeSync) {
          return function (name, parentName, isPlugin) {
            ...
            if (parentName) var parentPackageName = getPackage(loader, parentName) || loader.defaultJSExtensions && parentName.substr(parentName.length - 3, 3) == '.js' && getPackage(loader, parentName.substr(0, parentName.length - 3));
            ...
            if (parentPackage && name[0] != '.') {
              ...
              if (parentMapMatch && typeof parentMap[parentMapMatch] == 'string') return doMapSync(loader, parentPackage, parentPackageName, parentMapMatch, name, isPlugin);
            }
        ...
        function loadPackageConfigPath(loader, pkgName, pkgConfigPath) {
          ...
          return configLoader.load(pkgConfigPath).then(function () {
            ...
            for (var p in cfg) {
              if (indexOf.call(packageProperties, p) == -1) delete cfg[p];
            }
            ...
            if (cfg.depCache) {
              for (var d in cfg.depCache) {
                ...
                if (d.substr(0, 2) == './') dNormalized = pkgName + '/' + d.substr(2);else dNormalized = coreResolve.call(loader, d);
          ...
          return function (load) {
            ...
            return Promise.resolve(locate.call(this, load)).then(function (address) {
              ...
              if (pkgName) {
                ...
                // format
                if (pkg.format) load.metadata.format = load.metadata.format || pkg.format;
      ...
      (function () {
        ...
        if (typeof document != 'undefined') var head = document.getElementsByTagName('head')[0];
        ...
        function getInteractiveScriptLoad() {
          if (interactiveScript && interactiveScript.script.readyState === 'interactive') return interactiveScript.load;
        ...
        hook('pushRegister_', function (pushRegister) {
          return function (register) {
            ...
            else if (ieEvents) this.reduceRegister_(getInteractiveScriptLoad(), register);
        ...
        function webWorkerImport(loader, load) {
          return new Promise(function (resolve, reject) {
            ...
            if (!load.metadata.entry) reject(new Error(load.address + ' did not call System.register or AMD define'));
        ...
        hook('fetch', function (fetch) {
          return function (load) {
            ...
            if (load.metadata.format == 'json' || !load.metadata.scriptLoad || !isBrowser && !isWorker) return fetch.call(this, load);
            ...
            return new Promise(function (resolve, reject) {
              ...
              function complete(evt) {
                ...
                // if nothing registered, then something went wrong
                if (!load.metadata.entry && !load.metadata.bundle) reject(new Error(load.name + ' did not call System.register or AMD define. If loading a global module configure the global name via the meta exports property for script injection support.'));
      ...
      (function () {
        ...
        hook('reduceRegister_', function () {
          return function (load, register) {
            ...
            if (!entry.name || load && entry.name == load.name) {
              ...
              if (curMeta.entry) {
                if (curMeta.format == 'register') throw new Error('Multiple anonymous System.register calls in module ' + load.name + '. If loading a bundle, ensure all the System.register calls are named.');else throw new Error('Module ' + load.name + ' interpreted as ' + curMeta.format + ' module format, but called System.register.');
              }
          ...
          for (var i = 0, l = entry.normalizedDeps.length; i < l; i++) {
            ...
            if (depEntry.groupIndex === null || depEntry.groupIndex < depGroupIndex) {
              ...
              if (depEntry.groupIndex !== null) {
                ...
                if (groups[depEntry.groupIndex].length == 0) throw new Error("Mixed dependency cycle detected");
              }
        ...
        function linkDynamicModule(entry, loader) {
          ...
          var output = entry.execute.call(__global, function (name) {
            ...
            if (indexOf.call(entry.normalizedDeps, nameNormalized) != -1) return getModule(nameNormalized, loader);
          ...
          else if (entry.esmExports && exports !== __global) entry.esModule = getESModule(exports);
          ...
          return function (load) {
            ...
            // or via the dynamic formats
              ...
              // (dont run bundles in the builder)
                  ...
                  if (!load.metadata.entry && !load.metadata.bundle) throw new Error(load.name + ' detected as ' + load.metadata.format + ' but didn\'t execute.');
          ...
          return function (load) {
            ...
            return translate.call(loader, load).then(function (source) {
              ...
              if (load.metadata.format == 'esm' || load.metadata.format == 'es6' || !load.metadata.format && source.match(esmRegEx)) {
                ...
                if (loader.pluginLoader) loader.pluginLoader._loader.loadedTranspiler = loader._loader.loadedTranspiler || false;
                ...
                return (loader._loader.transpilerPromise || (loader._loader.transpilerPromise = Promise.resolve(__global[loader.transpiler == 'typescript' ? 'ts' : loader.transpiler] || (loader.pluginLoader || loader)['import'](loader.transpiler)))).then(function (transpiler) {
                  ...
                  if (transpiler.translate) {
                    ...
                    if (transpiler == load.metadata.loaderModule) return load.source;

                    // convert the source map into an object for transpilation chaining
                    if (typeof load.metadata.sourceMap == 'string') load.metadata.sourceMap = JSON.parse(load.metadata.sourceMap);

                    return Promise.resolve(transpiler.translate.call(loader, load)).then(function (source) {
                      // sanitize sourceMap if an object not a JSON string
                      var sourceMap = load.metadata.sourceMap;
                      if (sourceMap && (typeof sourceMap === 'undefined' ? 'undefined' : _typeof(sourceMap)) == 'object') {
                      ...
                      if (load.metadata.format == 'esm' && !loader.builder && detectRegisterFormat(source)) load.metadata.format = 'register';
                      return source;
                    });
                  }
              ...
              if (loader.transpiler === false) return source;
              ...
              if (loader._loader.loadedTranspiler === false && (loader.transpiler == 'traceur' || loader.transpiler == 'typescript' || loader.transpiler == 'babel') && load.name == loader.normalizeSync(loader.transpiler)) {
                ...
                if (source.length > 100 && !load.metadata.format) {
                  ...
                  if (loader.transpiler === 'traceur') load.metadata.exports = 'traceur';
                  if (loader.transpiler === 'typescript') load.metadata.exports = 'ts';
                }
              ...
              if (loader._loader.loadedTranspilerRuntime === false) {
                if (load.name == loader.normalizeSync('traceur-runtime') || load.name == loader.normalizeSync('babel/external-helpers*')) {
                  if (source.length > 100) load.metadata.format = load.metadata.format || 'global';
      ...
      */
      ...
      hook('fetch', function (fetch) {
        return function (load) {
          if (load.metadata.exports && !load.metadata.format) load.metadata.format = 'global';
          return fetch.call(this, load);
        };
      });
      ...
      function getGlobalValue(exports) {
        if (typeof exports == 'string') return readMemberExpression(exports, __global);
      ...
      hookConstructor(function (constructor) {
        return function () {
          ...
          function forEachGlobal(callback) {
            if (Object.keys) Object.keys(__global).forEach(callback);else for (var g in __global) {
          ...
          loader.set('@@global-helpers', loader.newModule({
            prepareGlobal: function prepareGlobal(moduleName, exports, globals) {
        ...
        function getCJSDeps(source) {
          ...
          if (source.length / source.split('\n').length < 200) {
            while (match = stringRegEx.exec(source)) {
              ...
              if (!inLocation(stringLocations, match)) commentLocations.push([match.index, match.index + match[0].length]);
            }
          }
          ...
          return function (load) {
            ...
            if (load.metadata.format == 'cjs') {
              ...
              entry.execute = function (_require, exports, module) {
                ...
                if (!load.metadata.cjsDeferDepsExecute) for (var i = 0; i < metaDeps.length; i++) {
                  require(metaDeps[i]);
                ...
                if (load.metadata.globals) for (var g in load.metadata.globals) {
      ...
      hookConstructor(function (constructor) {
        return function () {
          ...
          loader.set('@@cjs-helpers', loader.newModule({
            requireResolve: function requireResolve(request, parentId) {
              return stripOrigin(loader.normalizeSync(request, parentId));
            },
            getPathVars: function getPathVars(moduleId) {
        ...
        return function () {
          ...
          */
          ...
          function define(name, deps, factory) {
            ...
            if ((exportsIndex = indexOf.call(deps, 'exports')) != -1) deps.splice(exportsIndex, 1);

            if ((moduleIndex = indexOf.call(deps, 'module')) != -1) deps.splice(moduleIndex, 1);
          ...
          hook('reduceRegister_', function (reduceRegister) {
            return function (load, register) {
              ...
              if (curMeta) {
                if (!curMeta.format || curMeta.format == 'detect') curMeta.format = 'amd';else if (!entry.name && curMeta.format != 'amd') throw new Error('AMD define called while executing ' + curMeta.format + ' module ' + load.name);
              }
              ...
              // named define
                  ...
                  if (curMeta) {
                    if (!curMeta.entry && !curMeta.bundle) curMeta.entry = entry;else if (curMeta.entry && curMeta.entry.name) curMeta.entry = undefined;
      ...
      */
      ...
      (function () {
        function getParentName(loader, parentName) {
          ...
          if (parentName) {
            ...
            if (loader.pluginFirst) {
              if ((parentPluginIndex = parentName.lastIndexOf('!')) != -1) return parentName.substr(parentPluginIndex + 1);
            } else {
              if ((parentPluginIndex = parentName.indexOf('!')) != -1) return parentName.substr(0, parentPluginIndex);
            }
        ...
        function createNormalizeSync(normalizeSync) {
          return function (name, parentName, isPlugin) {
            ...
            if (!parsed) return normalizeSync.call(this, name, parentName, isPlugin);
        ...
        hook('normalize', function (normalize) {
          return function (name, parentName, isPlugin) {
            ...
            if (!parsed) return normalize.call(loader, name, parentName, isPlugin);
        ...
        hook('locate', function (locate) {
          return function (load) {
            ...
            return locate.call(loader, load).then(function (address) {
              ...
              return loader.normalize(load.metadata.loader, load.name).then(function (loaderNormalized) {
          ...
          return function (load) {
            ...
            if (load.metadata.loaderModule && load.metadata.loaderModule.translate && load.metadata.format != 'defined') {
              return Promise.resolve(load.metadata.loaderModule.translate.call(loader, load)).then(function (result) {
                ...
                // sanitize sourceMap if an object not a JSON string
                if (sourceMap) {
                  if ((typeof sourceMap === 'undefined' ? 'undefined' : _typeof(sourceMap)) != 'object') throw new Error('load.metadata.sourceMap must be set to an object.');
                ...
                if (typeof result == 'string') load.source = result;else warn.call(this, 'Plugin ' + load.metadata.loader + ' should return the source in translate, instead of setting load.source directly. This support will be deprecated.');
        ...
        hook('instantiate', function (instantiate) {
          return function (load) {
            ...
            if (load.metadata.loaderModule && load.metadata.loaderModule.instantiate && !loader.builder && load.metadata.format != 'defined') return Promise.resolve(load.metadata.loaderModule.instantiate.call(loader, load, function (load) {
      ...
      function resolveCondition(conditionObj, parentName, bool) {
        return this['import'](conditionObj.module, parentName).then(function (m) {
          if (conditionObj.prop) m = readMemberExpression(conditionObj.prop, m);else if ((typeof m === 'undefined' ? 'undefined' : _typeof(m)) == 'object' && m + '' == 'Module') m = m['default'];

          if (bool && typeof m != 'boolean') throw new TypeError('Condition ' + serializeCondition(conditionObj) + ' did not resolve to a boolean.');
      ...
      function interpolateConditional(name, parentName) {
        ...
        return resolveCondition.call(this, conditionObj, parentName, false).then(function (conditionValue) {
          ...
          if (conditionValue.indexOf('/') != -1) throw new TypeError('Unabled to interpolate conditional ' + name + (parentName ? ' in ' + parentName : '') + '\n\tThe condition value ' + conditionValue + ' cannot contain a "/" separator.');
      ...
      */
      ...
      if (( false ? 'undefined' : _typeof(exports)) === 'object') module.exports = Loader;
      ...
      if (( false ? 'undefined' : _typeof(exports)) === 'object') module.exports = System;
  ...
  // importScripts
      ...
      if (doPolyfill) importScripts(basePath + 'system-polyfills.js');
      bootstrap();
    } else {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(0), "/index.js"))
...
!function (a, b, c) {
  ...
  !function (a) {
    ...
    a.exports = c(2);
  }]), "undefined" != typeof module && module.exports ? module.exports = a :  true ? !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
    return a;
  }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : b.core = a;
}(1, 1);
