...
var LineChartAreaComponent = (function () {
    function LineChartAreaComponent() {
        this.chart = {
            type: 'Line',
            data: mock_data_1.datas['areaLineData'],
            options: mock_data_1.datas['areaLineData'].options
        };
    }
    return LineChartAreaComponent;
}());
LineChartAreaComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
