...
var PieSimpleComponent = (function () {
    function PieSimpleComponent() {
        this.chart = {
            type: 'Pie',
            data: mock_data_1.datas['simplePieData'],
            options: mock_data_1.datas['simplePieData'].options
        };
    }
    return PieSimpleComponent;
}());
PieSimpleComponent = __decorate([
    core_1.Component({
        moduleId: module.id,
